namespace AlquilerApp_Proyecto.Forms
{
    partial class frmCrudUsuario
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnGuardar.Location = new Point(335, 358);
            btnGuardar.Name = "btnGuardar";
            btnGuardar.Padding = new Padding(0, 0, 10, 0);
            btnGuardar.Size = new Size(196, 44);
            btnGuardar.TabIndex = 108;
            ...
            cmbEmpleados.Location = new Point(350, 284);
            cmbEmpleados.Name = "cmbEmpleados";
            cmbEmpleados.Size = new Size(197, 28);
            cmbEmpleados.TabIndex = 116;
            // 
            // label8
            // 
            label8.AutoSize = true;
            label8.ForeColor = Color.Red;
            label8.Location = new Point(200, 279);
            label8.Name = "label8";
